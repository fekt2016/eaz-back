...
# Buyer auth gate
export BUYER_LOGIN_BODY_JSON='{"email":"buyer@example.com","password":"your-password"}'
...
# Seller auth gate
export SELLER_LOGIN_BODY_JSON='{"email":"seller@example.com","password":"your-password"}'
...
# Admin auth gate
export ADMIN_LOGIN_BODY_JSON='{"email":"admin@example.com","password":"your-password"}'
