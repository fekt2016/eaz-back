...
router
  .route('/shipping-fees')
  .get(saiisaiStoreController.getOfficialStoreShippingFees)
  .patch(saiisaiStoreController.updateOfficialStoreShippingFees);

// Pickup centers routes
router.get('/pickup-centers', saiisaiStoreController.getPickupCenters);
